                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                        <div class="position-relative">
                            <input type="text" name="search" class="form-control rounded-pill ps-4"
                                placeholder="Cari Barang Hilang..." style="width:250px;" value="{{ request('search') }}">
                ...
                <form method="GET" action="{{ route('lost-items.index') }}" id="filterForm">
                    <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                        ...
                        <div class="align-self-end">
                            <a href="{{ route('lost-items.index') }}" class="btn btn-secondary rounded-pill px-4">
                    ...
                    @foreach ($items as $item)
                        <div class="item-card">
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('lost-found.show', $item->id) }}" class="detail-btn mt-2">Lihat
                                    Detail</a>
                            </div>
