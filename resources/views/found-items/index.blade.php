            ...
            <div class="container-fluid">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                        ...
                        <img src="/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTAxL3JtNjA5-LXNvbGlkaWNvbi13LTAwMi1wLnBuZw.webp"
                             class="profile-img">
                    </a>
            ...
            <form method="GET" action="{{ route('found-items.index') }}">
                <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <button type="submit" class="btn btn-link position-absolute" style="top:0; right:5px;">
...
<div class="min-vh-100 pb-5">
    ...
    <div class="container mt-5 p-4 rounded shadow" style="background:#9FB6C7;">
        ...
        <form method="GET" action="{{ route('found-items.index') }}">
            <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                <div class="position-relative">
                    <input type="text" name="search" class="form-control rounded-pill ps-4" placeholder="Cari Barang Ditemukan..." style="width:250px;" value="{{ request('search') }}">
                    <button type="submit" class="btn btn-link position-absolute" style="top:0; right:5px;">
                        <i class="fa-solid fa-magnifying-glass" style="color:gray;"></i>
                    </button>
                </div>
                ...
                @foreach($items as $item)
                    <div class="item-card">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="fw-bold">{{ $item->judul }}</h5>
                            <p class="mb-1"><i class="fa-solid fa-user"></i> Dilaporkan oleh: {{ $item->user->name }}</p>
                            <p class="mb-1"><i class="fa-solid fa-location-dot"></i> Lokasi Ditemukan: {{ $item->lokasi }}</p>
