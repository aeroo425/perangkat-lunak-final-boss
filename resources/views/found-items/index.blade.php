...
<div class="container mt-5 p-4 rounded shadow" style="background:#9FB6C7;">
    ...
    <div class="d-flex justify-content-between mb-4">
        ...
        <a href="{{ route('found-items.create') }}" class="add-btn">
            <i class="fa fa-plus"></i> Laporkan Barang Ditemukan
        </a>
    </div>
    ...
    <form method="GET" class="d-flex flex-wrap gap-3 mb-4">
        ...
        <a href="{{ route('found-items.index') }}" class="btn btn-secondary rounded-pill">
            Reset
        </a>
    </form>
        ...
        <div class="item-card mb-3">
            ...
            <div class="text-end">
                <div class="d-flex align-items-center gap-2 text-success fw-bold">
                    <div class="status-dot"></div> DITEMUKAN
                </div>
                <a href="{{ route('lost-found.show', $item->id) }}"
                   class="detail-btn mt-2 d-inline-block">
                    Lihat Detail
                </a>
            </div>
